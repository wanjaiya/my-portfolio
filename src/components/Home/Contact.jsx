    ...
    <div name='contact' className='w-full h-screen bg-[#05113f] text-gray-300 flex justify-center items-center p-4'>
      ...
      <form action="https://getform.io/f/5c0416c9-a31f-400f-b771-eccf530ad504" method='POST' className='flex flex-col max-w-[600px] w-full'>
        <div className='pb-2'>
            ...
            <p className='text-grey-300 py-4'> Submit the form below</p>
        </div>

        <input type='text' placeholder='Name' name='name' className='p-2 bg-[#ccd6f6] text-black'/>

        <input type='email' placeholder='Email' name='email' className='my-4 p-2 bg-[#ccd6f6] text-black' />

        <textarea name="message"  cols="30" rows="10" placeholder='Message' className='p-2 bg-[#ccd6f6] text-black'></textarea>
